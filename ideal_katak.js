...
/* SEARCH */
#searchBox { width:200px;padding:6px;margin-bottom:10px; border-radius:8px; border:1px solid #ccc; }
.cell.highlight { background-color:#fffde7 !important; transition:0.3s; }
</style>
</head>
<body>

<input id="searchBox" placeholder="Kod yoki raqam yozing..." oninput="searchCode()">
...
function searchCode(){
    ...
    document.querySelectorAll('.cell').forEach(cell=>{
        ...
        cell.querySelectorAll('.item-entry').forEach(item=>{
            const code = item.dataset.code.toUpperCase();

            if(val && code.includes(val)) {
