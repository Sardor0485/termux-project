...
// Termux wake-lock — telefon uxlamasligi uchun
const { execSync } = require('child_process');
try { execSync('termux-wake-lock'); console.log('✅ Termux wake-lock yoqildi'); }
catch(e) { console.log('⚠️  termux-wake-lock ishlamadi (Termux emas?)'); }

app.listen(3000, '0.0.0.0', () => {
    console.log('🟢 Ambar Pro ishga tushdi: port 3000');
    console.log('🌐 Tarmoqdan kirish: http://192.168.1.27:3000');
});
